...
static const char *fonts[]          = {
	"icons:size=28",
	"Incosolata:style=bold:size=14"
};
static const char dmenufont[]       = "Inconsolata:style=bold:size=14";

static const char col_gray1[]       = "#fdf7e1";
static const char col_gray2[]       = "#2a3334";
static const char col_gray3[]       = "#e15443";
static const char col_gray4[]       = "#282a36";
static const char col_cyan[]        = "#48e16e";
